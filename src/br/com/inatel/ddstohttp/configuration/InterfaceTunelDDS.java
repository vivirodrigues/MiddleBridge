package br.com.inatel.ddstohttp.configuration;
...
import br.com.inatel.ddstohttp.dds.DataDDS;
import br.com.inatel.ddstohttp.dds.Discovery;
import br.com.inatel.ddstohttp.dds.myExampleSubscriber;
...
public class InterfaceTunelDDS extends JFrame {	
	
	private JPanel contentPane;
	private JTextField txt_ipDDS;
	private JTextField txt_DomainDDS;
	private JTextField txt_TopicDDS;
	...
	public DataDDS dataDDS = new DataDDS();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfaceTunelDDS frame = new InterfaceTunelDDS();
	...
	public InterfaceTunelDDS() throws IOException {
	...
	public void initialize() throws IOException {						
		...
		panel.setBounds(368, 11, 348, 567);
		...
		JLabel lblNewLabel = new JLabel("DDS");
		lblNewLabel.setBounds(131, 7, 91, 41);
		lblNewLabel.setForeground(Color.BLACK);
		lblNewLabel.setFont(new Font("Times New Roman", Font.BOLD, 35));
		panel_1.add(lblNewLabel);
		
		JLabel lblIp = new JLabel("Domain ID: *");
		lblIp.setHorizontalAlignment(SwingConstants.CENTER);
		lblIp.setForeground(Color.BLACK);
		lblIp.setFont(new Font("Times New Roman", Font.BOLD, 20));
		lblIp.setBounds(10, 59, 121, 24);
		panel_1.add(lblIp);
		...
		/* Domain */
		txt_DomainDDS = new JTextField();
		txt_DomainDDS.setText("0");
		txt_DomainDDS.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		txt_DomainDDS.setBounds(143, 64, 162, 20);
		panel_1.add(txt_DomainDDS);
		txt_DomainDDS.setColumns(10);
		
		/* Topic */
		txt_TopicDDS = new JTextField();
		txt_TopicDDS.setText("Hello, World");
		txt_TopicDDS.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		txt_TopicDDS.setBounds(143, 99, 162, 20);
		panel_1.add(txt_TopicDDS);
		txt_TopicDDS.setColumns(10);
		
		JLabel lblIp_1 = new JLabel("IP Address: *");
		lblIp_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblIp_1.setForeground(Color.BLACK);
		lblIp_1.setFont(new Font("Times New Roman", Font.BOLD, 20));
		lblIp_1.setBounds(10, 129, 121, 24);
		panel_1.add(lblIp_1);
		
		txt_ipDDS = new JTextField();
		txt_ipDDS.setText("192.168.0.110");
		txt_ipDDS.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		txt_ipDDS.setColumns(10);
		txt_ipDDS.setBounds(143, 133, 162, 20);
		panel_1.add(txt_ipDDS);
		...
		btnSubscribe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				myExampleSubscriber myExample = new myExampleSubscriber();				
				...
				// start DDS
				discovery.connection(dataDDS);		
				
				try {
					// start subscriber DDS 
					myExample.connection(dataDDS, dataHttp, message, httpConnection.list_headers_v, httppost);
				} catch (IOException e) {
	...
	public void setDDS() {
		// set the DDS domain		
		String domainID = txt_DomainDDS.getText();
		int domain = Integer.parseInt(domainID);
		dataDDS.setDomain(domain);
		// set the DDS topic
		String topic = txt_TopicDDS.getText();
		dataDDS.setTopic(topic);
		// set the DDS server
		String ipDDS = txt_ipDDS.getText();
		dataDDS.setIP(ipDDS);
	}
